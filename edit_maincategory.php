...
<?php
...

	{
		...
		$stmt_edit = $DB_con->prepare('SELECT * FROM product_maincategory WHERE product_maincategory_id =:scid');
...

	{
		...
		$product_main_text = $_POST['product_main_text'];

		if(!isset($errMSG))

		{

			$stmt = $DB_con->prepare('UPDATE product_maincategory

									     SET product_main_text=:product_main_text

								       WHERE product_maincategory_id=:scid');
			
			$stmt->bindParam(':product_main_text',$product_main_text);

			$stmt->bindParam(':scid',$id);

			if($stmt->execute()){

				$successMSG = "Main Category Successfully Updated ...";
...
<head>
  ...
  <title>Edit Main Category | Invoice System</title>
...
<!-- Start wrapper-->
 <div id="wrapper">
   ...
   <!--Start product_maincategory_idebar-wrapper-->
   <?php
  require_once 'sidermenu.php';
   ?>
   <!--End product_maincategory_idebar-wrapper-->
      ...
      <div class="row">
		...
		<?php
          ...
          <form action="" method="POST" enctype="multipart/form-data">
					  ...
					  <div class="col-sm-12">
					  <label for="input-8" class="col-form-label">Main Category Name</label>
                      <input type="text" class="form-control" id="input-8" name="product_main_text" value="<?php echo $product_main_text; ?>" required>
                      </div>
                      </div>
                      ...
                      <div class="modal-footer">
                        <a class="btn btn-secondary" href="mainmaincategory.php"><i class="fa fa-times"></i> Close</a>
