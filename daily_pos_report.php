...
<head>
    ...
    <title>Daily Exchange Report</title>
                ...
                <div class="content-header">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="mr-auto">
                            ...
                            <h3 class="page-title">Daily Exchange Report</h3>
                            ...
                            <div class="d-inline-block align-items-center">
                                ...
                                <nav>
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Daily Exchange Report</li>
...
<form method="post">
	<table>
		<tbody>
			<tr>
				<td>Start Date:<input name="start_date" type="date" required class="form-control" id="start_date" max="<?php echo date(" Y-m-d "); ?>">
				</td>
				<td>End Date:<input name="end_date" type="date" required class="form-control" id="end_date" max="<?php echo date(" Y-m-d "); ?>">
				</td>
				<td>Sale Type:
					<select name="sale_type" required="required" class="form-control" id="sale_type">
						<option value="" hidden="yes">Select</option>
						<option value="Cash Payment">Cash Payment</option>
						<option value="Cash Payment">Card Payment</option>
						<option value="Textile Loan">Textile Loan</option>
					</select>
				</td>
				<td><br><button name="filter_bt" type="submit" class="btn btn-sm btn-success">Run Report</button>
				</td>
			</tr>
		</tbody>
	</table>
...
<button type="button" class="btn btn-sm btn-dark" onClick="printDiv('print_aria');">Print Daily Exchange Report</button>

<div id="print_aria">

<div class="print-title">
<img src="images/bbill_logo.png" style="height: 80px;"><br>
<strong>Daily Exchange Report</strong><br>
...
Sale Type: <?php if(isset($_POST['filter_bt'])){ echo $_POST['sale_type']; } ?><br>
...
$sd_qury=mysqli_query($connation,"SELECT DISTINCT(ps.pos_sale_date) AS sale_date
FROM pos_sale ps
WHERE ps.pos_sale_date BETWEEN '$_POST[start_date]' AND '$_POST[end_date]'
ORDER BY ps.pos_sale_date");
while($sd_resalt=mysqli_fetch_assoc($sd_qury)){
?>

<tr>
<td colspan="8"><strong>Date: </strong><?php echo $sd_resalt['sale_date']; ?></td>
</tr>
	
<?php
$no_count=0;
$list_qury=mysqli_query($connation,"SELECT *
...
WHERE ps.pos_sale_date='$sd_resalt[sale_date]' AND sb.product_sub_istock_id='$log_user_resalt[branch]' AND ps.sale_type='$_POST[sale_type]'
ORDER BY ps.pos_sale_invoice");
while($list_resalt=mysqli_fetch_assoc($list_qury)){
$no_count++;
?>
<tr>
<td><?php echo number_format((float)$no_count); ?></td>
<td><?php echo $list_resalt['sale_list_barcode']; ?></td>
<td><?php echo $list_resalt['product_main_text']; ?> - <?php echo $list_resalt['product_sub_name']; ?></td>
<td><?php echo number_format((float)$list_resalt['product_main_price'],2); ?></td>
<td>1</td>
<td><?php echo number_format((float)$list_resalt['product_main_price'],2); ?></td>
<td><?php echo $list_resalt['pos_sale_invoice']; ?></td>
<td><?php echo date("Y-m-d h:i:s A",strtotime($list_resalt['pos_sale_date']." ".$list_resalt['pos_sale_time'])); ?></td>
</tr>
<?php
}
}
