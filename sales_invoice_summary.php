                ...
                <div class="content-header">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="mr-auto">
                            ...
                            <h3 class="page-title">Sales Invoice Report</h3>
...
<table>
  <tbody>
    <tr>
      <td>Start Date:<input type="date" class="form-control" id="start_date" placeholder="Start Date" data-date-format="yyyy-mm-dd" value="<?php echo $start_date; ?>"></td>
      <td>End Date:<input type="date" class="form-control" id="end_date" placeholder="End Date" data-date-format="yyyy-mm-dd" value="<?php echo $end_date; ?>"></td>

      <td><br>
           <?php
        $sql = "SELECT * FROM institution_list";
  ...
  // output data of each row
        ...
        while($row = $result->fetch_assoc()) {
            $rowcount = $rowcount +1;
            ?>
            <option value="<?php echo $row["Institution_list_id"]; ?>"><?php echo $row["Institution_list_name"]; ?> | <?php echo $row["Institution_list_later"]; ?></option>
            <?php
        }
...
?>
		...
		<td><br><button name="filter_bt" type="button" class="btn btn-sm btn-success" onclick="loadSalesInvoice();">Run Report</button></td>
    </tr>
  </tbody>
</table>
</form>
