...
if(isset($_POST['add_bt'])){
	...
	if(mysqli_num_rows($check_invoice)>0){
		...
		if($check_invoice_resalt['product_sub_status']==4||$check_invoice_resalt['product_sub_status']==3){
		...
		if(mysqli_query($connation,"UPDATE product_sub_barcode SET product_sub_status='1' WHERE product_sub_barcode='$product_sub_barcode'")){
                            ...
                            <div class="d-inline-block align-items-center">
                                ...
                                <nav>
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Return Manage</li>
                        ...
                        <div class="col-12">
                            ...
                            <div class="box">
                                ...
                                <div class="box-header with-border">
                                    ...
                                    <h4 class="box-title">Returen Products</h4>
...
<?php if($message_display==3){ ?><div class="alert alert-danger m-4 p-2">Allready added this item Reject or Sold list, Please Try again.</div><?php } ?>

<?php if($message_display==2){ ?><div class="alert alert-info m-4 p-2">Product reject added success!</div><?php } ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="product_sub_barcode" class="form-control" required>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <button class="btn btn-success btn-sm"  name="add_bt" type="submit">Add Return </button>
