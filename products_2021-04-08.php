...
$list_qury=mysqli_query($connation,"SELECT * FROM $join_str ORDER BY product_main_barcode.product_main_id DESC");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="d-flex align-items-center gap-items-2">
                                                            ...
                                                            <a href="print.php?warp=<?php echo $list_resalt['product_main_warp']; ?>"><i class="mdi mdi-printer"></i></a>

                                                            <a href="view_sub_barcode.php?warp=<?php echo $list_resalt['product_main_warp']; ?>"><i class="fa fa-eye-slash"></i></a>

                                                            <?php /*?><a href="products.php?warp=<?php echo $list_resalt['product_main_warp']; ?>" onClick="JavaScript:return confirm('Are you sure remove this product?');"><i class="fa fa-trash text-danger fa-lg"></i></a><?php */?>
...
$bar_count=mysqli_query($connation,"SELECT * FROM product_sub_barcode WHERE product_sub_main_warp='$list_resalt[product_main_warp]'")	;
...
<span class="badge badge-danger"><?php echo $delete; ?></span>
                                                    ...
                                                    <td><?php echo $list_resalt['product_sub_later']; ?> - <?php echo $list_resalt['product_sub_name']; ?></td>

                                                    <td><?php echo $list_resalt['Institution_list_later']; ?> - <?php echo $list_resalt['Institution_list_name']; ?></td>
