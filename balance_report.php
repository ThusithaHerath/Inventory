...
<head>
    ...
    <title>Balance Report | Dashboard</title>
                ...
                <div class="content-header">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="mr-auto">
                            ...
                            <h3 class="page-title">Balance Report</h3>
                            ...
                            <div class="d-inline-block align-items-center">
                                ...
                                <nav>
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Balance Report</li>
...
<table>
  <tbody>
    <tr>
      <td>
		<select name="mc" id="mc" class="form-control">
...
while($mc_list_resalt=mysqli_fetch_assoc($mc_list_qury)){
      ...
      <td><button name="filter_btn" type="submit" class="btn btn-sm btn-dark">Filter</button></td>
    </tr>
  </tbody>
</table>
...
<button type="button" class="btn btn-sm btn-dark" onClick="printDiv('print_aria');">Print Balance Report</button>

<div id="print_aria">

<div class="print-title">
<img src="images/bbill_logo.png" style="height: 80px;"><br>
<strong>Balance Report</strong><br>
...
$sc_qury=mysqli_query($connation, $sql);



while($sc_resalt=mysqli_fetch_assoc($sc_qury)){

$sql = "SELECT COUNT(*) AS count_val
FROM product_sub_barcode
WHERE product_sub_main_warp='$sc_resalt[product_sub_later]' and product_sub_status IN ('1','2')";
...
$sql = "SELECT product_sub_norep
FROM product_sub_barcode
WHERE product_sub_main_warp='$sc_resalt[product_sub_later]'";
...
if (empty($count_resalt)) {
    continue;
}

$product_sub_main_id = $count_resalt['product_sub_main_id'];


$sql = "SELECT product_main_price
FROM product_main_barcode WHERE product_main_norep='". $product_sub_norep."'";

$query=mysqli_query($connation,$sql);
