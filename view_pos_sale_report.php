                        ...
                        <div class="col-12">
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <hr>
<a type="button" class="btn btn-sm btn-dark" href="pos_sale_report.php">Back</a>
...
$list_qury=mysqli_query($conn,"SELECT * FROM $join_str WHERE sale_list_invoice='$invoice' AND is_duplicate = 0 ORDER BY sale_list_id DESC");
