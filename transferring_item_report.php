...
<head>
    ...
    <title>Product Transferring Items Report | Dashboard</title>
...
$transfer_key = htmlspecialchars($_GET['transfer_key']);

$sql = "SELECT * FROM product_transferring WHERE transfer_key= '". $transfer_key. "'";
...
<tfoot>
    <tr>
        <td rowspan="3">Total ammount : <?php echo number_format($total_amount,2); ?></td>
    </tr>
</tfoot>
</table>
