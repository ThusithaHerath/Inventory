...
$sql = "SELECT * FROM product_sub_barcode WHERE product_sub_norep= '$warp' ORDER BY product_sub_stock_available DESC ";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    ...
    <tr>
    	...
    	<td><?php echo $row["product_sub_main_warp"]; ?></td>
    	<td><?php echo $row["product_sub_barcode"]; ?></td>
    	<td><?php
    	if($row["product_sub_stock_available"]>0){
    		echo '<span class="badge badge-success">Received</span>';
    	}else{
    		echo '<span class="badge badge-danger">Not Received</span>';
    	} ?></td>
