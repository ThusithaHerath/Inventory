                            ...
                            <div class="d-inline-block align-items-center">
                                ...
                                <nav>
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Stocks Report</li>
                        ...
                        <div class="col-12">
                            ...
                            <div class="box">
                                ...
                                <div class="box-header with-border">
                                    ...
                                    <h4 class="box-title">Stocks Report</h4>
                                        ...
                                        <table class="table mb-0 w-p100">
                                            ...
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th style="text-align: right;">Total Products</th>
...
$list_qury=mysqli_query($connation,"SELECT * FROM thlocation ORDER BY lid");
...
$count=mysqli_query($connation,"SELECT COUNT(*) AS count_product FROM product_sub_barcode WHERE product_sub_istock_id='$list_resalt[lid]'");

$count_resalt=mysqli_fetch_array($count);
