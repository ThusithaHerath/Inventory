...
<head>
  ...
  <title>Reviews | Invoice System</title>
<?php
...
include('connect.php');
$result = $db->prepare("SELECT * FROM thsales WHERE invoice_number= :userid");
...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="100%">
		...
		<tbody>
				...
				<?php
					$id=$_GET['invoice'];
					$result = $db->prepare("SELECT * FROM thsales_order WHERE invoice= :userid");
				...
				<tr>
					...
					<?php
					$sdsd=$_GET['invoice'];
					$resultas = $db->prepare("SELECT sum(amount) FROM thsales_order WHERE invoice= :a");
