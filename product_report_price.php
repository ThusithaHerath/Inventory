...
<head>
    ...
    <title>Price Wise Product Report | Dashboard</title>
                ...
                <div class="content-header">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="mr-auto">
                            ...
                            <h3 class="page-title">Price Wise Product Report</h3>
                            ...
                            <div class="d-inline-block align-items-center">
                                ...
                                <nav>
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Price Wise Product Report</li>
    ...
    <tr>
      <td>
		...
		<option value="" hidden="yes">-Select-</option>
			<option <?php if(isset($_POST['mc'])){if($_POST['mc']=="all"){echo "selected";}} ?> value="all">All Product</option>
		  <?php 
...
while($mc_list_resalt=mysqli_fetch_assoc($mc_list_qury)){
			?>
			<option <?php if(isset($_POST['mc'])){if($_POST['mc']==$mc_list_resalt['product_main_id']){echo "selected";}} ?> value="<?php echo $mc_list_resalt['product_main_id']; ?>"><?php echo $mc_list_resalt['product_main_text']; ?></option>
			<?php } ?>
		  </select>
		</td>
		<td>
		...
		<select name="status" required="required" id="status" class="form-control">
			<option value="" hidden="yes">-Select-</option>
			<option <?php if(isset($_POST['status'])){if($_POST['status']==0){echo "selected";}} ?> value="0">Delete</option>
			<option <?php if(isset($_POST['status'])){if($_POST['status']==1){echo "selected";}} ?> value="1">Active</option>
			<option <?php if(isset($_POST['status'])){if($_POST['status']==2){echo "selected";}} ?> value="2">Pending</option>
			<option <?php if(isset($_POST['status'])){if($_POST['status']==3){echo "selected";}} ?> value="3">Sold</option>
			<option <?php if(isset($_POST['status'])){if($_POST['status']==4){echo "selected";}} ?> value="4">Reject</option>
			</select>
		</td>
...
<button type="button" class="btn btn-sm btn-dark" onClick="printDiv('print_aria');">Print Price Wise Product Report</button>

<div id="print_aria">

<div class="print-title">
<img src="images/bbill_logo.png" style="height: 80px;"><br>
<strong>Price Wise Product Report</strong><br>
Created: <?php echo $current_date." ".$current_time; ?><br>
<?php if(isset($_POST['mc'])){if($_POST['mc']=="all"){echo "Product: All Product<br>";}} ?>
...
?>
    ...
    <tr style="text-transform: capitalize; font-weight: bold; border-bottom: 1px dashed #000000;">
      ...
      <td><?php echo $mc_resalt['product_main_text']; ?></td>
      <td></td>
      <td></td>
      <td></td>
    </tr>
...
$count_qury=mysqli_query($connation,"SELECT COUNT(*) AS count_val,mp.product_main_price
FROM product_sub_barcode sp INNER JOIN product_main_barcode mp ON sp.product_sub_norep=mp.product_main_norep
WHERE mp.product_main_sub_cat='$sc_resalt[product_sub_id]' and sp.product_sub_status='$_POST[status]'
GROUP BY mp.product_main_price");
while($count_resalt=mysqli_fetch_assoc($count_qury)){
	
$main_total+=($count_resalt['count_val']*$count_resalt['product_main_price']);
?>
    <tr style="text-transform: capitalize;">
      <td><?php echo $sc_resalt['product_sub_later']; ?></td>
      <td><?php echo $sc_resalt['product_sub_name']; ?></td>
		<td align="right"><?php echo number_format((float)$count_resalt['product_main_price'],2); ?></td>
      <td align="right"><?php echo number_format((float)$count_resalt['count_val'],0); ?></td>      
      <td align="right"><?php echo number_format((float)$count_resalt['count_val']*$count_resalt['product_main_price'],2); ?></td>
    </tr>
<?php } } ?>
    <tr style="text-transform: capitalize; font-weight: bold; background-color: #DDDDDD;">
      <td colspan="4">Sub Amount</td>
      <td align="right"><?php echo number_format((float)$main_total,2); ?></td>
    </tr>
<?php
